...
function Navbar({ searchQuery, setSearchQuery, currentDate, setCurrentDate, tasks }) {
  ...
  return (
    <div className='w-full bg-amber-50 px-6 md:px-20 py-4 flex flex-wrap gap-4 md:gap-10 items-center shadow-xl justify-start 2xl:justify-start sm:justify-center'>
      ...
      <div className='block 2xl:hidden [color:#FF6767] font-semibold text-2xl md:text-3xl'>
        <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#FF6767">
          <path d="M4 12H20M4 8H20M4 16H12" stroke="#FF6767" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
      </div>
