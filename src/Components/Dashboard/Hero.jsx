            ...
            <div className='flex flex-col justify-start items-center gap-5 shadow-2xl w-[100%] h-auto rounded-2xl py-2 pb-4 px-4'>
                ...
                <div className='flex justify-center items-center gap-3 w-[98%] h-35 '>
                    <div className='flex flex-col justify-start items-center h-full w-full sm:w-[45%] lg:w-[30%]'>
                        <div className='w-[100px] h-[80%]'><CircularProgressbar styles={buildStyles({pathTransitionDuration: 2.0,pathColor: `rgba(0, 184, 21, ${Completedpercentage / 100})`,strokeLinecap: 'butt'})} strokeWidth={12} counterClockwise={true} value={Completedpercentage} text={`${Completedpercentage}%`} /></div>
                    ...
                    <div className='flex flex-col justify-center items-center gap-2 h-full w-full sm:w-[45%] lg:w-[30%]'>
                        <div className='w-[100px] h-[80%]'><CircularProgressbar styles={buildStyles({pathTransitionDuration: 2.0,pathColor: `rgba(3, 0, 184, ${Progresspercentage / 100})`,strokeLinecap: 'butt'})} strokeWidth={12} counterClockwise={true} value={Progresspercentage} text={`${Progresspercentage}%`} /></div>
                        <div className='flex justify-center lg:justify-start  items-center w-[100%] h-[20%] font-semibold'><img src={blueDot} />In Progress</div>
                    </div>
                    <div className='flex flex-col justify-center items-center gap-2 h-full w-full sm:w-[45%] lg:w-[30%]'>
                        <div className='w-[100px] h-[80%]'><CircularProgressbar styles={buildStyles({pathTransitionDuration: 2.0,pathColor: `rgba(220, 0, 0, ${Notpercentage / 100})`,strokeLinecap: 'butt'})} strokeWidth={12} counterClockwise={true} value={Notpercentage} text={`${Notpercentage}%`} /></div>
